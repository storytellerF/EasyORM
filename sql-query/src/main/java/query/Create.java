...
public class Create implements Query {
    ...
    public Create(Class<?> tableClass) {
    ...
    public String parse(boolean safe) throws UnexpectedException {
        ...
        HashMap<String, query.ForeignKey> foreignKeyMap=new HashMap<>();
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            if (field.isAnnotationPresent(ForeignKey.class)) {
                ...
                foreignKeyMap.put(columnName,new query.ForeignKey(foreignKey.tableClass(),foreignKey.column()));
            }
        ...
        for (String key : set) {
            query.ForeignKey foreignKey = foreignKeyMap.get(key);
