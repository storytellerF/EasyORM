...
import com.gui.createHtml.BootstrapType;
import com.gui.createHtml.DiTing;
import com.gui.createHtml.HTMLFormItem;
...
public class GenerateHTMLFormElement {
    ...
    public void initEditor() {
        ...
        try {
            htmlConfigEditor.init("com.gui.generate_html", runtimeTypeAdapterFactory);
        } catch (IOException e) {
            e.printStackTrace();
        }
